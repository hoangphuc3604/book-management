      ...
      <div className="flex-1 container py-8">
        ...
        {error && (
          <div className="bg-destructive/15 text-destructive p-4 rounded-md">
            <p>Có lỗi xảy ra khi tải thông tin tác giả. Vui lòng thử lại sau.</p>
          </div>
        )}
        ...
        {!isLoading && !error && author && (
          <div className="max-w-4xl mx-auto">
            <Card className="mb-8">
              ...
              <CardContent>
                <div>
                  <h3 className="text-lg font-medium mb-4">Danh sách sách của tác giả</h3>
                  
                  {author.books.length === 0 ? (
                    <div className="text-center py-6 bg-muted/30 rounded-md">
                      <Book className="h-8 w-8 mx-auto mb-2 text-muted-foreground" />
                      <p className="text-muted-foreground">Tác giả này chưa có sách nào</p>
                    </div>
                  ) : (
                    <Table>
                      <TableHeader>
